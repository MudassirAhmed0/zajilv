...
const TrackingContent = () => {
  ...
  return (
    ...
    <div className={`flex flex-col w-full ${ trackingResult && "md:mt-20 md:mb-20 mt-16"} transition-all duration-500 overflow-hidden ${trackingResult ?" max-h-120 " : " max-h-0 " }`}>
