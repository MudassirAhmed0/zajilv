...
import styles from '../../../arStyles2/Terms.module.css'
            ...
            <span className='absolute bottom-[-76px] right-[-55px] w-[307px] h-[267px] img_container'>
                ...
                <div className='max-1394 mx-auto'>
                    <div className='lg:w-10/12 w-full'>
                        <h2 className='text-3xl text-grey medium'>Heading here</h2>
                        <ul className='mt-3'>
                            <li className='flex gap-x-6 items-start mt-6'>
