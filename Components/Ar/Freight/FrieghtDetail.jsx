            ...
            <div className='max-1394 mx-auto overflow-hidden xl:px-20 xl:pt-24 px-[18px] pt-[56px] relative'>
                <div className={`flex lg:flex-nowrap flex-wrap-reverse justify-between items-center gap-x-16`}>
                    <div ref={textContainer} className=' xl:mt-0 mt-[35px] '>
                        ...
                        <p className='text-base light-font text-grey mt-5 pl-5'>Learn how to get the most value from available bulk item shipping and freight with Zajil. From traditional domestic Drayage to intermodal and multi-configuration container transport anywhere on Earth, Zajil has the technology and the expertise to optimize a shipping and receiving network that suits your business needs.</p>
                        <p className='text-base light-font text-grey mt-5 pl-5 pb-5'> Our growing footprint includes distribution centers and customs experts in major economic hubs on every continent. Discover how Zajil can expand your capacity to meet demand and acquire new opportunity in a global market. Talk to a Zajil Business Freight Solution Architect today.</p>
                    </div>
