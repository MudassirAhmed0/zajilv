    ...
    <section ref={content} className=" flex flex-col items-center md:pt-16 pt-14">
      ...
      <div className="w-4/5 max-1394 flex justify-between text-grey mt-12  gap-y-8 flex-wrap ">
        ...
        <Link href="/ar/shipment" >
          <a className="md:w-1/3 w-1/2 flex md:border-none  border-t-none border-borderGrey  	 parent items-center justify-center flex-col pt-2 pb-2 gap-y-3" >
        ...
        <Link href="/ar/get-pricing" >
          <a className="md:w-1/3 w-5/12 flex border-t-none border-borderGrey md:border-r border-borderGrey   mx-auto md:mx-0  	 parent items-center justify-center flex-col pt-6 pb-2 gap-y-3" >
             <span className='hover:scale-[1.2] transition-all duration-300'>
