        ...
        <Image src={yellowBox} alt="Yellow Box" />
          ...
          if(isVisible){
              setShow1(true)
                    ...
                    <span className="medium-font text-grey fadeLeftt md:pl-0 md:pr-[30px] pl-4 ">
          ...
          if(isVisible){
              setShow2(true)
                    ...
                    <span className="text-blue bold-font pl-6 md:pl-[28px]  relative pb-2 mb-4 fadeRightt  border-b border-yellow text-4xl ">
                        2015    
                        <span className={styles.leftBox}>
                            <Image width={20} height={20} src={box} alt='box'/>
                        </span>
                    </span>
                    <span className="medium-font  pl-6 text-grey pb-4 fadeRightt md:pl-[28px]">
                    Now with more than 10 locations, Zajil becomes the first privately-owned company to be licensed for postal delivery service in KSA. Acquires Hat International (HATEX) and expands into line hauling and heavy shipping, and other B2B services.
                     ...
                     <ul className=' flex flex-col gap-y-2 pl-4  pb-4 md:pb-0 md:pl-[28px]'>
          ...
          if(isVisible){
              setShow3(true)
                    ...
                    <span className="text-blue bold-font relative md:pl-0 pl-4   md:pr-[30px] pb-2 mb-4  fadeLeftt  border-b border-yellow text-4xl">
                    2018    
                        <span className={styles.rightBox}>
                            <Image width={20} height={20} src={box} alt='box'/>
                        </span>
                    </span>
                    <span className="medium-font fadeLeftt text-grey md:pr-[30px]  md:pl-0 pl-4">
                    ...
                    <ul className=' flex flex-col gap-y-2 mt-3 fadeLeftt md:pl-0  md:pr-[30px] pl-4'>
          ...
          if(isVisible){
              setShow4(true)
                    ...
                    <span className="text-blue bold-font pl-6  relative pb-2 mb-4 fadeRightt md:pl-[28px]  border-b border-yellow text-4xl ">
                    2020    
                        <span className={styles.leftBox}>
                            <Image width={20} height={20} src={box} alt='box'/>
                        </span>
                    ...
                    Zajil delivers 416k shipments per month on average to 279 destinations.
                     ...
                     <ul className=' flex flex-col gap-y-2 pl-4 fadeRightt pb-4 md:pb-0 md:pl-[28px]'>
                         <li className={`medium-font  pl-6 text-grey ${styles.historyListItem}`}>
          ...
          if(isVisible){
              setShow5(true)
                    ...
                    <span className="text-blue bold-font md:pl-0 pl-4 relative pb-2 mb-4 md:pr-[30px]   fadeLeftt border-b border-yellow text-4xl">
                    2021    
                        <span className={`z-10 ${styles.rightBox}`}>
                            <Image width={20} height={20} src={box} alt='box'/>
                        </span>
                    </span>
                    <span className={`medium-font text-grey fadeLeftt md:pl-0 pl-4 md:pr-[30px] `}>
                    ...
                    <ul className=' flex flex-col gap-y-2 mt-3 fadeLeftt md:pl-0 pl-4 md:pr-[30px]' >
                         <li className={`medium-font  pl-4 text-grey ${styles.historyListItem}`}>
                         Fulfillment
                         </li>
                         <li className={`medium-font  pl-4 text-grey ${styles.historyListItem}`}>
