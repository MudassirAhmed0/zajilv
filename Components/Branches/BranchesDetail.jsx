...
const BranchesDetail = ({ step, setStep, state, setState, handleDropDownClick }) => {
    ...
    return (
        <div className={`flex ${styles.wrap} md:max-h-[803px]`}>
            <div className={`${styles.flterWidth} shadow-map z-10`}>
                ...
                <div className={`${styles.filetTwo}`}>
                    <div className={styles.maxHeight}>
                        ...
                        <div className='flex items-center mt-3 gap-x-3.5'>
                            ...
                            <p className={`text-lg text-grey light-font pr-5`}>Sunday - Thursday ( 7AM - 11PM ) Saturday ( 7AM - 10PM )</p>
                        </div>
